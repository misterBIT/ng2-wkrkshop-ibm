...
The only difference from the source at [angular/quickstart](https://github.com/angular/quickstart) is that testing has been removed from this clone for simplification sake.
